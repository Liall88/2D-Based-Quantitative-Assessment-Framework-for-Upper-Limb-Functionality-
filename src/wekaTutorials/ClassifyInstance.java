 ...
 *  
 *  
 *  Making predictions for numeric values
 */
...
public class ClassifyInstance{
	public static void main(String args[]) throws Exception{
		...
		DataSource source = new DataSource("/homes/la2817/Desktop/Outputs/arff_Outputs/trainingData/iris/iris.arff");
		...
		//load new dataset
		DataSource source1 = new DataSource("/homes/la2817/Desktop/Outputs/arff_Outputs/testData/iris/iris-unknown.arff");
		...
		//build model
		SMOreg smo = new SMOreg(); //smo regression model
